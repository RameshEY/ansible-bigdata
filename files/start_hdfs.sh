...
sleep 60
docker -H tcp://master:4000 run -d --name nodemanager1 --net=bde_net -h nodemanager1.hadoop -e constraint:node==master  --env-file=./hadoop.env bde2020/hadoop-nodemanager:1.0.0
sleep 60
